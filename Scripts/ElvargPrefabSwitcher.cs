...
public class ElvargPrefabSwitcher : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isInCombat && hitPoints > 0)
        {
            ...
            {
                // Debug.Log("atacking");
                int randomPrefabIndex = Random.Range(2, 5); // Randomly choose between prefab2, prefab3, and prefab4
                SwitchPrefab(randomPrefabIndex);
    ...
    private void HandleDeath()
    {
        ...
        isInCombat = false;
        SwitchPrefab(6); // Play death animation
